...
import { logger } from  '../../web3-functions/airseeker/logging';
import { initializeState } from '../../web3-functions/airseeker/state';
...
// Mock API server
app.get('/convert', (req:any, res:any) => {
...
app.post('/signed-data-gateway/:endpoint', async (req:any, res:any) => {
